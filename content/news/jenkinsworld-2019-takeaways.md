...
<img width="70%" height="70%" alt="Capabilities of Jenkins X" src="images/jenkins-x-architecture.png">
...
[VMWare's Octant UI tool](https://github.com/vmware/octant) enables introspection, navigation and object mahagement of your Kubernetes cluster. It runs on your local client just like kubectl. An advantage of Octant is that it authenticates the same way as kubectl: if kubectl works, octant works.
...
*   Jenkins X pipelines are based on [Tekton pipelines](https://github.com/tektoncd/pipeline). This mode is controlled by the new 
    `jenkins-x.yml file`. The syntax of this YAML file resembles the Jenkinsfile declarative pipeline syntax. This mode is the
    new default and this mode is recommended for the long term.
