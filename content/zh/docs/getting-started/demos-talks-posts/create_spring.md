...
该 [示例](https://www.youtube.com/watch?v=kPes3rvT1UM) 使用命令 [jx create spring](/commands/deprecation/) 来 [创建带有持续集成、部署流水线的 Spring Boot 应用](/developing/create-spring/) 并使用 [GitOps 提升](/docs/concepts/features/#promotion)：
