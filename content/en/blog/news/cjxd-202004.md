...
The benefits of deprecating unsupported features and commands allows for more focus, clearer messaging, better documentation, better quality, faster development of new features, and expanding Kubernetes provider support.  You can learn more about our decision to remove traditional Jenkins masters [here](https://jayex.io/blog/2020/03/11/tekton/).
...
- Terraform: Hardy Ferentschik has been working diligently on an effort
  ...
  [Jenkins X Documentation](https://jayex.io/docs/getting-started/).
