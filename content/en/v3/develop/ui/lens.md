...
linktitle: Lens
type: docs
description: desktop JayeX Console based on Lens 
weight: 50
---
...
## Install the JayeX extension

[Lens](https://k8slens.dev/) supports [extensions](https://k8slens.dev/#extensions) to support custom UIs for different extensions to Kubernetes such as JayeX.
                
Follow the Lens documentation on [installing an extension](https://docs.k8slens.dev/main/extensions/usage/#installing-an-extension) using the following URL for the [JayeX Lens extension](https://github.com/jenkins-x-plugins/jx-lens)
...
You should see the `JayeX` tab below the `Custom Resources` section. If you expand that you can then navigate to your `Pipelines` and `Preview` environments as well.