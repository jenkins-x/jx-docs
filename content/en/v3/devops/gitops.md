...
We prefer [using external secrets stores](/v3/admin/setup/secrets/) via the open source  [External Secrets Operator](https://github.com/external-secrets/external-secrets) project
