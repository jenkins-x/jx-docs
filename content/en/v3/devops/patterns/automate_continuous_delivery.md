...
If you use JayeX for your environments and to [create projects](/v3/develop/create-project/) you will have completely automated Continuous Delivery using [Pipelines As Code](/v3/devops/patterns/pipeline_as_code/), [Preview Environments](/v3/devops/patterns/preview_environments/) and [Trunk Based Development](/v3/devops/patterns/trunk_based_development/)
