...
linktitle: From 2.x
type: docs
description: Migrate to the 3.0 Beta from older JayeX installations
weight: 100
---

If you wish to migrate from older versions of JayeX to v3 we recommend [spinning up a new cluster for v3](/v3/admin/platform/) and then incrementally moving projects from the old cluster to the new cluster.
...
* now connect to your old JayeX cluster. Using jx v2 you can use `jx ctx` to switch contexts or refer to your cloud providers documentation on how to switch `kubectl` to point to different clusters
