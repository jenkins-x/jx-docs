...
linktitle: Google
type: docs
description: Setup JayeX on Google Cloud with GKE
date: 2017-02-01
...
- Ensure **Owner** is the Git Organisation that will hold the repositories used for JayeX.
...
The following demo walks through how to get started with JayeX 3 on GKE + Terraform
