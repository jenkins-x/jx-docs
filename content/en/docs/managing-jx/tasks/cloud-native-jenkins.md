...
When you [create a cluster](getting-started/create-cluster/) or [install Jenkins X](/docs/managing-jx/tasks/install-on-cluster/) you are prompted to pick between the available build packs.
...
We want you to [extend Jenkins X](/extending/) so please check out the [documentation on creating your own build packs](/docs/managing-jx/tasks/build-packs/#creating-new-build-packs)
