...
For help on switching contexts see: https://jenkins-x.io/docs/using-jx/tasks/kube-context/
...
For more help on available commands see: https://jenkins-x.io/docs/using-jx/tasks/browsing/
