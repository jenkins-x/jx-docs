...
The easiest way to do that is passing in `--env-remote`  when you [created your environment git repositories](/docs/v3/guides/getting-started/repository/):

``` 
jx admin create --env-remote
```

Or if you've already [created your environment git repositories](/docs/v3/guides/getting-started/repository/) you can modify your `jx-requirements.yml` to something like this:
...
Follow the [getting started guide for helm 3 boot](/docs/v3/guides/getting-started/) to setup the secrets and boot up the development cluster.
...
Then you will need to follow the instructions to [setup the cloud resources for the Staging/Production cluster](/docs/v3/guides/getting-started/cloud/)
...
Then follow the [secrets setup](/docs/v3/guides/getting-started/secrets/) and  [run the boot job](/docs/v3/guides/getting-started/run/) for the `staging` / `production` environment
...
If you want to add any more apps to your cluster, use the [jx add app](/docs/v3/guides/apps/#adding-apps-or-charts) command.
