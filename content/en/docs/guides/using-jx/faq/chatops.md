...
[Prow](/docs/reference/components/prow/) and [Lighthouse](/architecture/lighthouse/) support both webhooks and [ChatOps](/docs/guides/using-jx/faq/chatops/) whereas Jenkins just supports webhooks only.
...
See also [How do I map SourceRepository to a custom Scheduler?](/docs/faq//boot/#how-do-i-map-sourcerepository-to-a-custom-scheduler)
