---
date: 2019-09-28T14:21:30Z
title: "jx create terraform gke"
slug: jx_create_terraform_gke
url: /commands/jx_create_terraform_gke/
---
## jx create terraform gke

Creates a Jenkins X Terraform plan for GKE
...
```
  ...
  -c, --cluster stringArray                    Name and Kubernetes provider (currently gke only) of clusters to be created in the form --cluster foo=gke
      ...
      --disk-size string                       Size in GB for node VM boot disks. Defaults to 100GB (default "100")
      ...
      --enable-autorepair                      Sets autorepair feature for a cluster's default node-pool(s) (default true)
  ...
  -h, --help                                   help for gke
      ...
      --machine-type string                    The type of machine to use for nodes
  ...
  -o, --organisation-name string               The organisation name that will be used as the Git repo containing cluster details, the repo will be organisation-<org name>
      ...
      --project-id string                      Google Project ID to create cluster in
      ...
      --use-enhanced-apis                      Enable enhanced APIs to utilise Container Registry & Cloud Build
      --use-enhanced-scopes                    Use enhanced Oauth scopes for access to GCS/GCR
      ...
      --zone string                            The compute zone (e.g. us-central1-a) for the cluster
```
...
###### Auto generated by spf13/cobra on 28-Sep-2019
