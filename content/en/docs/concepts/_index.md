...
are based on the comprehensive research done for the book [*ACCELERATE: Building and Scaling High Performing Technology Organizations*](https://goo.gl/vZ8BFN). You can read why we use [Accelerate](/docs/overview/accelerate/) for the principles behind Jenkins X.
